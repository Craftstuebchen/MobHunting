...
public class Bounty {
    ...
    public Bounty(ConfigManager configManager, RewardManager rewardManager) {
     ...
     */
    public Bounty(ConfigManager configManager, RewardManager rewardManager, String worldGroup, OfflinePlayer bountyOwner, OfflinePlayer wantedPlayer, double prize,
                  String message) {
        this(configManager, rewardManager);
        // Bounty on a Player
        ...
        this.endDate = this.createdDate + (long) configManager.bountyDaysToLive * 86400000L;
        this.prize = prize;
        this.message = message;
        this.status = BountyStatus.open;
    }

    public Bounty(ConfigManager configManager, RewardManager rewardManager, String worldGroup, OfflinePlayer randomPlayer, double prize, String message) {
        this(configManager, rewardManager);
    ...
    public Bounty(ConfigManager configManager, RewardManager rewardManager, String worldGroup, OfflinePlayer bountyOwner, int npcId, double prize, String message) {
        this(configManager, rewardManager);
        // Bounty on a NPC
        this.worldGroup = worldGroup;
        this.bountyOwner = bountyOwner;
    ...
    public Bounty(ConfigManager configManager, RewardManager rewardManager, String worldGroup, OfflinePlayer bountyOwner, String mobId, double prize, String message) {
        // Bounty on a Mob
        this.worldGroup = worldGroup;
        this.bountyOwner = bountyOwner;
        this.mobtype = "Mob";
    ...
    public Bounty(Bounty bounty) {
        this.rewardManager = bounty.rewardManager;
        this.configManager = bounty.configManager;
        bountyOwnerId = bounty.bountyOwnerId;
        // bountyId = bounty.getBountyId();
        bountyOwner = bounty.bountyOwner;
        mobtype = bounty.mobtype;
        wantedPlayerId = bounty.wantedPlayerId;
        wantedPlayer = bounty.wantedPlayer;
        npcId = bounty.npcId;
        mobId = bounty.mobId;
        worldGroup = bounty.worldGroup;
        this.createdDate = System.currentTimeMillis();
        this.endDate = this.createdDate + (long) configManager.bountyDaysToLive * 86400000L;
        prize = bounty.prize;
    ...
    public String toString() {
        return String.format(
                ...
                npcId, mobId, rewardManager.format(prize), status);
    }
    ...
    /**
     * @param bountyOwnerId the bountyOwnerId to set
     */
    ...
    /**
     * @param bountyOwner the bountyOwner to set
     */
    ...
    /**
     * @param wantedPlayerId the wantedPlayerId to set
     */
    ...
    /**
     * @param wantedPlayer the wantedPlayer to set
     */
    ...
    /**
     * @param status the completed to set
     */
