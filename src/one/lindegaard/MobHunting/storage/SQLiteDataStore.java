...
import one.lindegaard.MobHunting.*;
...
public class SQLiteDataStore extends DatabaseDataStore {
    public SQLiteDataStore(ConfigManager configManager, PlayerSettingsManager playerSettingsManager, DataStoreManager dataStoreManager, RewardManager rewardManager, ExtendedMobManager extendedMobManager, Messages messages, CustomMobsCompat customMobsCompat) {
    ...
    public List<StatStore> loadPlayerStats(StatType type, TimePeriod period, int count) throws DataStoreException {
        ...
        if (type.getDBColumn().equalsIgnoreCase("total_kill") || type.getDBColumn().equalsIgnoreCase("total_assist")
            ...
            wherepart = (id != null
                    ...
                    + extendedMobManager.getMobIdFromMobTypeAndPluginID(mobType, plugin)
                    : " AND mh_Mobs.MOB_ID="
                    + extendedMobManager.getMobIdFromMobTypeAndPluginID(mobType, plugin));
        }
    ...
    protected void setupV2Tables(Connection connection) throws SQLException {
        ...
        String lm = configManager.learningMode ? "1" : "0";
