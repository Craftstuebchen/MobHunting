...
public class LeaderboardCommand implements ICommand, Listener {
    ...
    private void onClickSign(PlayerInteractEvent event) {
        ...
        if (state.create) {
            ...
            WorldLeaderboard board = plugin.getLeaderboardManager()
            ...
            if (board != null) {
                ...
                if (state.addType != null) {
                    ...
                    System.arraycopy(state.addType, 0, types, original.length, state.addType.length);
                    board.setType(types);
                }
                ...
                if (state.addPeriod != null) {
                    ...
                    System.arraycopy(state.addPeriod, 0, types, original.length, state.addPeriod.length);
                ...
                plugin.getLeaderboardManager().saveWorld(board.getWorld());
            } else
